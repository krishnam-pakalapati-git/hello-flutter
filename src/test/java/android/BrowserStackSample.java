...
public class BrowserStackSample {
  ...
  public static void main(String[] args)
	...
	caps.setCapability("browserstack.user", "krishnamraju_Bp56Dy");
	caps.setCapability("browserstack.key", "fdpcF956bpRVGopr5eak");
	
/*	caps.setCapability("browserstack.user", "svcbs_dFnVg6gQ4eo");
	caps.setCapability("browserstack.key", "BByFbgxbsATNEiSYjzq1");*/
    ...
    caps.setCapability("app_url", "bs://056237cc3302be579399ab99d27448de5304a6b8");
    ...
    AndroidDriver driver = new AndroidDriver(
    	      new URL("https://krishnamraju_Bp56Dy:fdpcF956bpRVGopr5eak@hub-cloud.browserstack.com/wd/hub"),
    	      caps
    	    );
